...
namespace App.Data.Migrations
{
    ...
    [Migration("20220618155844_AddedNotificationsPropertyToUser")]
    partial class AddedNotificationsPropertyToUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("App.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("App.Data.Models.BankEmployee", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("App.Data.Models.CardHolder", b =>
                {
                    ...
                    b.Property<decimal>("PaymentCardNumber")
                        .HasColumnType("decimal(20,0)");

                    b.Property<DateTime>("PaymentCardValidUntil")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("App.Data.Models.BankEmployee", b =>
                {
                    b.HasOne("App.Data.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("App.Data.Models.Discount", b =>
                {
                    b.HasOne("App.Data.Models.Shopkeeper", "Shopkeeper")
                        .WithMany()
            ...
            modelBuilder.Entity("App.Data.Models.DiscountVote", b =>
                {
                    ...
                    b.HasOne("App.Data.Models.Discount", "Discount")
                        .WithMany("DiscountVotes")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("App.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("App.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
